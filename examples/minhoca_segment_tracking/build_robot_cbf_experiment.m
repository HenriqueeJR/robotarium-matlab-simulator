function [cost, grad] = build_robot_cbf_experiment(W, params)
    ...
    % Nota: o gradiente para r4 é computado mas descartado via ~, pois r4 é parâmetro constante.
...
function [Cost, grad_pa, grad_pb] = calc_segment_p2s_penalty(pa, pb, blocks, h)
    ...
    % 3. Custo do segmento por polígono convexo (Soma das violações dos extremos)
    C1 = Pa1 + Pb1;
    C2 = Pa2 + Pb2;
    C3 = Pa3 + Pb3;
    C4 = Pa4 + Pb4;
