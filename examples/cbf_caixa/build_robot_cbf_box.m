...
function [cost, grad] = build_robot_cbf_box(u, params)
    ...
    Q_pos = 20; R_ctrl = 0.1; % R_ctrl aumentado para evitar curvas bruscas
    ...
    r_rob = 0.1;     % Raio do robô para inflar o obstáculo
    gamma_cbf = 0.85; % Taxa de decaimento menor para antecipar a curva
