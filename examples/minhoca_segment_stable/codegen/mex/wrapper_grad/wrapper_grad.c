...
static emlrtRSInfo emlrtRSI = {
    ...
    "simulator\\examples\\minhoca_segment_stable\\wrapper_grad.m" /* pathName */
};
...
static emlrtECInfo emlrtECI = {
    ...
    "C:\\Users\\henri\\Desktop\\robotarium_ws_old\\robotarium-matlab-"
    "simulator\\examples\\minhoca_segment_stable\\build_robot_cbf_exp"
    "eriment.m" /* pName */
};
...
void wrapper_grad(const emlrtStack *sp, const real_T u[50],
                  const real_T params[37], real_T grad[50])
{
  __m128d b_r1;
  __m128d b_r2;
  __m128d b_r3;
  ...
  a = (int32_T)muDoubleScalarFloor(params[7] + 1.0);
  if (params[7] + 1.0 != a) {
  ...
  v2 = phi_func(params[0] - params[33], &g_corridor);
  v3 = phi_func(params[34] - params[1], &g_corridor);
  denom_huber = phi_func(params[1] - params[35], &g_corridor);
  ...
  r4 = _mm_set1_pd(
      2.0 * (params[29] +
             params[30] *
                 muDoubleScalarExp(-params[31] *
                                   (0.25 * (((v1 + v2) + v3) + denom_huber)))));
  ...
  for (n = 0; n < i1; n++) {
    ...
    if (((int32_T)b_n < 1) || ((int32_T)b_n > i2)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)b_n, 1, i2, &e_emlrtBCI, &st);
    }
    ...
    g_corridor = X_hist_data[loop_ub] - xs_tmp;
    a = X_hist_data[loop_ub + 1] - b_xs_tmp;
    denom_huber =
        muDoubleScalarSqrt((g_corridor * g_corridor + a * a) + 0.0001);
    grad_xs_tmp = c_pos * g_corridor / denom_huber;
    grad_xs[0] -= grad_xs_tmp;
    v3 = c_pos * a / denom_huber;
    grad_xs[1] -= v3;
    v2 = v_n - v_s;
    grad_us_idx_0 -= v2;
    v1 = u[(int32_T)b_u + 1] - w_s;
    grad_us_idx_1 -= v1;
    /*  Avaliação Suavizada Ponto a Ponto para CBF */
    a = calc_point_p2s_penalty(&X_hist_data[loop_ub], &params[10], a__2);
    denom_huber = calc_point_p2s_penalty(&X_hist_data[3 * (int32_T)b_n],
                                         &params[10], gP_seg0_xs);
    g_corridor = (1.0 - gamma_safe) * -a - (-denom_huber);
    x_next[0] = 0.0;
    ...
    a = X_hist_data[loop_ub + 2];
    denom_huber = muDoubleScalarCos(a);
    a = muDoubleScalarSin(a);
    grad_x_next_cbf[0] += x_k[0];
    grad_x_next_cbf[1] += x_k[1];
    grad_x_next_cbf[2] += x_k[2];
    dv[2] = -Ts * v_n * a;
    dv[5] = Ts * v_n * denom_huber;
