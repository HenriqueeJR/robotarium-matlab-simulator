                    ...
                    const real_T params[36])
{
  ...
  P_test = get_single_block_p2s(b_params, &params[32], a__1);
  ...
  for (n = 0; n < i1; n++) {
    ...
    /*  =========================================================================
     */
    c_params[0] = params[10];
    c_params[1] = params[11];
    c_params[2] = params[12];
    c_params[3] = params[13];
    idx_r1 = get_single_block_p2s(&x_k[0], c_params, a__1);
    c_params[0] = params[14];
    c_params[1] = params[15];
    c_params[2] = params[16];
    c_params[3] = params[17];
    idx_r2 = get_single_block_p2s(&x_k[0], c_params, b_params);
    c_params[0] = params[18];
    c_params[1] = params[19];
    c_params[2] = params[20];
    c_params[3] = params[21];
    idx_r3 = get_single_block_p2s(&x_k[0], c_params, gPg);
    c_params[0] = params[22];
    c_params[1] = params[23];
    c_params[2] = params[24];
    c_params[3] = params[25];
    work = get_single_block_p2s(&x_k[0], c_params, gPc);
    c_st.site = &x_emlrtRSI;
    tmp2 = smooth_min_func(&c_st, idx_r1, idx_r2, a__1, b_params, g1);
    c_st.site = &y_emlrtRSI;
    idx_r2 = smooth_min_func(&c_st, idx_r3, work, gPg, gPc, b_params);
    c_st.site = &ab_emlrtRSI;
    P_k = smooth_min_func(&c_st, tmp2, idx_r2, g1, b_params, a__1);
    idx_r1 = Ts * v_n;
    ...
    c_params[2] = params[12];
    c_params[3] = params[13];
    idx_r1 = get_single_block_p2s(&x_next[0], c_params, a__1);
    c_params[0] = params[14];
    c_params[1] = params[15];
    c_params[2] = params[16];
    c_params[3] = params[17];
    idx_r2 = get_single_block_p2s(&x_next[0], c_params, b_params);
    c_params[0] = params[18];
    c_params[1] = params[19];
    c_params[2] = params[20];
    c_params[3] = params[21];
    idx_r3 = get_single_block_p2s(&x_next[0], c_params, gPg);
    c_params[0] = params[22];
    c_params[1] = params[23];
    c_params[2] = params[24];
    c_params[3] = params[25];
    work = get_single_block_p2s(&x_next[0], c_params, gPc);
    c_st.site = &x_emlrtRSI;
    tmp2 = smooth_min_func(&c_st, idx_r1, idx_r2, a__1, b_params, g1);
    c_st.site = &y_emlrtRSI;
    idx_r2 = smooth_min_func(&c_st, idx_r3, work, gPg, gPc, b_params);
    c_st.site = &ab_emlrtRSI;
    idx_r1 = smooth_min_func(&c_st, tmp2, idx_r2, g1, b_params, a__1);
  ...
  idx_r1 = calc_segment_p2s_penalty(&b_st, xs, r1, &params[10], a__1, b_params);
  /*  Segmento 2: r1 até r2 */
  b_st.site = &i_emlrtRSI;
  idx_r2 = calc_segment_p2s_penalty(&b_st, r1, r2, &params[10], a__1, b_params);
  /*  Segmento 3: r2 até r3 */
  b_st.site = &j_emlrtRSI;
  idx_r3 = calc_segment_p2s_penalty(&b_st, r2, r3, &params[10], a__1, b_params);
  /*  Segmento 4: r3 até r4 (x_ref) */
  b_st.site = &k_emlrtRSI;
  P_k = calc_segment_p2s_penalty(&b_st, r3, &params[3], &params[10], a__1,
                                 b_params);
  /*  Pesos de suavização  */
  work = u[0];
  ...
  cost =
      (((((((l_u + params[26] * sumColumnB(gPg)) +
           ...
           (params[29] + params[30] * muDoubleScalarExp(-params[31] * P_test)) *
               (((sumColumnB(gPc) + sumColumnB(g1)) + sumColumnB(y)) +
                sumColumnB(b_y))) +
          params[28] * idx_r1) +
         params[28] * idx_r2) +
        params[28] * idx_r3) +
