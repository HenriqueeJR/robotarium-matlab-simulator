function cost = wrapper_cost(u, params)
    ...
    cost_base = build_robot_cbf_box(u, params);
    ...
    R_dv = 0.2; % Penalidade para variação de velocidade linear
    R_dw = 0.2; % Penalidade para variação de velocidade angular (Alta para matar o zigue-zague)
