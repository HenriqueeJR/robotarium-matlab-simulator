                                 ...
                                 real_T L_safe, real_T W_safe, real_T grad_P[2])
{
  ...
  x_pos = pt[0] - x_obs[0];
  y_pos = pt[1] - x_obs[1];
  dy2 = muDoubleScalarAbs(x_pos);
  dx1 = muDoubleScalarMax(0.0, dy2 - L_safe);
  P2 = muDoubleScalarAbs(y_pos);
  dy1 = muDoubleScalarMax(0.0, P2 - W_safe);
  P1 = dx1 * dx1 + dy1 * dy1;
  dx2 = muDoubleScalarMax(0.0, dy2 - W_safe);
  dy2 = muDoubleScalarMax(0.0, P2 - L_safe);
  P2 = dx2 * dx2 + dy2 * dy2;
  P_cross = muDoubleScalarMin(P1, P2);
  grad_P[0] = 0.0;
  grad_P[1] = 0.0;
  if (P_cross > 0.0) {
    real_T gP2_idx_0;
    ...
    if (dx2 > 0.0) {
      gP2_idx_0 = 2.0 * dx2 * muDoubleScalarSign(x_pos);
    }
    if (dy2 > 0.0) {
      gP2_idx_1 = 2.0 * dy2 * muDoubleScalarSign(y_pos);
    }
    /*  Gradiente aponta para a região mais próxima */
    if (!(P1 <= P2)) {
      grad_P[0] = gP2_idx_0;
      grad_P[1] = gP2_idx_1;
    }
                                  ...
                                  const real_T params[17])
{
  ...
  if (cost < 1.0) {
    ...
    if (cost != (int32_T)muDoubleScalarFloor(cost)) {
      emlrtIntegerCheckR2012b(cost, &emlrtDCI, (emlrtConstCTX)sp);
    }
    if (((int32_T)cost < 1) || ((int32_T)cost > 51)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)cost, 1, 51, &emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i = (int32_T)cost;
  }
  if (cost + 1.0 != (int32_T)muDoubleScalarFloor(cost + 1.0)) {
    emlrtIntegerCheckR2012b(cost + 1.0, &i_emlrtDCI, (emlrtConstCTX)sp);
  }
  if (((int32_T)(cost + 1.0) < 1) || ((int32_T)(cost + 1.0) > 51)) {
    emlrtDynamicBoundsCheckR2012b((int32_T)(cost + 1.0), 1, 51, &k_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  xs_tmp = W[(int32_T)(cost + 1.0) - 1];
  xs[0] = xs_tmp;
  if ((cost + 1.0) + 1.0 != (int32_T)muDoubleScalarFloor((cost + 1.0) + 1.0)) {
    emlrtIntegerCheckR2012b((cost + 1.0) + 1.0, &i_emlrtDCI, (emlrtConstCTX)sp);
  }
  ...
  b_xs_tmp = W[(int32_T)((cost + 1.0) + 1.0) - 1];
  xs[1] = b_xs_tmp;
  if ((cost + 1.0) + 2.0 != (int32_T)muDoubleScalarFloor((cost + 1.0) + 2.0)) {
    emlrtIntegerCheckR2012b((cost + 1.0) + 2.0, &i_emlrtDCI, (emlrtConstCTX)sp);
  }
  ...
  xs[2] = W[(int32_T)((cost + 1.0) + 2.0) - 1];
  r1[0] = 0.0;
  r1[1] = 1.0;
  r = _mm_loadu_pd(&r1[0]);
  _mm_storeu_pd(&r2[0], _mm_add_pd(_mm_set1_pd(cost + 4.0), r));
  if (r2[0] != (int32_T)muDoubleScalarFloor(r2[0])) {
    emlrtIntegerCheckR2012b(r2[0], &e_emlrtDCI, (emlrtConstCTX)sp);
  }
  if (r2[1] != (int32_T)muDoubleScalarFloor(r2[1])) {
    emlrtIntegerCheckR2012b(r2[1], &e_emlrtDCI, (emlrtConstCTX)sp);
  }
  if (((int32_T)r2[0] < 1) || ((int32_T)r2[0] > 51)) {
    emlrtDynamicBoundsCheckR2012b((int32_T)r2[0], 1, 51, &g_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (((int32_T)r2[1] < 1) || ((int32_T)r2[1] > 51)) {
    emlrtDynamicBoundsCheckR2012b((int32_T)r2[1], 1, 51, &g_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  v_s_tmp = W[(int32_T)(cost + 4.0) - 1];
  w_s = W[(int32_T)((cost + 4.0) + 1.0) - 1];
  ...
  b_r3_tmp = W[(int32_T)((cost + 10.0) + 1.0) - 1];
  r3[1] = b_r3_tmp;
  /*  Limites Seguros */
  ...
  emxInit_real_T(sp, &X_hist, &b_emlrtRTEI);
  loop_ub = X_hist->size[0] * X_hist->size[1];
  X_hist->size[0] = 3;
  X_hist->size[1] = (int32_T)(params[14] + 1.0);
  emxEnsureCapacity_real_T(sp, X_hist, loop_ub, &b_emlrtRTEI);
  ...
  for (n = 0; n < i2; n++) {
    ...
    if ((loop_ub < 1) || (loop_ub > i)) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 1, i, &e_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    v_n = W[loop_ub - 1];
    loop_ub = (n << 1) + 2;
    if ((loop_ub < 1) || (loop_ub > i)) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 1, i, &f_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    w_n = W[loop_ub - 1];
