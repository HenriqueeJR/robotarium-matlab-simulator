...
function [cost, grad] = build_robot_cbf_experiment(W, params)
    ...
    if P_cross_xs > 0
        grad_xs(1:2) = grad_xs(1:2) + mu_safe * P_cross_xs * g_cross_xs;
    end
    if P_cross_r1 > 0
        grad_r1 = grad_r1 + mu_safe * P_cross_r1 * g_cross_r1;
    end
    if P_cross_r2 > 0
        grad_r2 = grad_r2 + mu_safe * P_cross_r2 * g_cross_r2;
    end
    if P_cross_r3 > 0
        grad_r3 = grad_r3 + mu_safe * P_cross_r3 * g_cross_r3;
    end
