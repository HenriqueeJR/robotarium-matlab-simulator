...
function [cost, grad] = build_robot_cbf_experiment(W, params)
    ...
    eta_term = 1000.0; eta_eq = 100.0; mu_obs = 1e5; mu_safe = 1000;
    kappa_s = 1000.0;
