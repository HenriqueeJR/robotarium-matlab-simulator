...
% Plot Dinâmico dos Blocos (Fronteiras Físicas Originais)
...
% Plot dos Limites Geométricos Erodidos (Safe Zones via blocks_params)
plot(ax, [blocks_params(1), blocks_params(2), blocks_params(2), blocks_params(1), blocks_params(1)], ...
         [blocks_params(3), blocks_params(3), blocks_params(4), blocks_params(4), blocks_params(3)], ...
         'b--', 'LineWidth', 1.5); % Bloco Azul

plot(ax, [blocks_params(5), blocks_params(6), blocks_params(6), blocks_params(5), blocks_params(5)], ...
         [blocks_params(7), blocks_params(7), blocks_params(8), blocks_params(8), blocks_params(7)], ...
         'r--', 'LineWidth', 1.5); % Bloco Vermelho

plot(ax, [blocks_params(9), blocks_params(10), blocks_params(10), blocks_params(9), blocks_params(9)], ...
         [blocks_params(11), blocks_params(11), blocks_params(12), blocks_params(12), blocks_params(11)], ...
         'g--', 'LineWidth', 1.5); % Bloco Verde

plot(ax, [blocks_params(13), blocks_params(14), blocks_params(14), blocks_params(13), blocks_params(13)], ...
         [blocks_params(15), blocks_params(15), blocks_params(16), blocks_params(16), blocks_params(15)], ...
         'c--', 'LineWidth', 1.5); % Bloco Ciano
